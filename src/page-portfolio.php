...
<section class="container flex-container">
    <div class="portfolio">
        <div class="portfolio-item">
            <figure style="background-image: url('https://blog.daniely.im/wp-content/uploads/2016/08/indecks-1024x672.png');">
            </figure>
            <figcaption>
                <h4>
        ...
        <div class="portfolio-item">
            <figure style="background-image: url('https://blog.daniely.im/wp-content/uploads/2017/03/breaking-bao-1024x873.png');">
            </figure>
            <figcaption>
                <h4>
        ...
        <div class="portfolio-item">
            <figure style="background-image: url('https://blog.daniely.im/wp-content/uploads/2016/08/yotta-991x1024.png');">
            </figure>
            <figcaption>
                <h4>
        ...
        <div class="portfolio-item">
            <figure style="background-image: url('https://blog.daniely.im/wp-content/uploads/2017/03/artgorithms-1024x748.png');">
            </figure>
            <!-- <figure>
                <h4 class="ital">
        ...
        <div class="portfolio-item">
            <figure style="background-image: url('https://blog.daniely.im/wp-content/uploads/2016/08/cspeak-661x1024.png');">
            </figure>
            <figcaption>
                <h4>
        ...
        <div class="portfolio-item">
            <figure style="background-image: url('https://blog.daniely.im/wp-content/uploads/2016/08/gerb-1024x691.png');">
            </figure>
            <figcaption>
                <h4>
